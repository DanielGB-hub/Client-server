...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(810, 632)  # размер фона окна чата
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.frame = QtWidgets.QFrame(self.centralwidget)
        self.frame.setGeometry(QtCore.QRect(10, 10, 778, 610))  # размер фона окна чата
        self.frame.setStyleSheet("QFrame{\n"
                                 "    border-radius: 7px;\n"
                                 "    background-color: #CFCFCF;\n"  # #1B1D23, CFCFCF  - фон(рамка)
                                 "}")
        ...
        self.lineEdit.setGeometry(QtCore.QRect(238, 350, 531, 152))  # окно ввода сообщения
        font = QtGui.QFont()
        ...
        self.pushButton.setGeometry(QtCore.QRect(599, 510, 170, 40))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(418, 560, 170, 40))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(599, 560, 170, 40))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.frame_3.setGeometry(QtCore.QRect(-1, 0, 779, 31))
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(738, 0, 41, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        # кнопка Закрыть окно Х
        ...
        # кнопка Свернуть окно _
        self.pushButton_5 = QtWidgets.QPushButton(self.frame_3)
        self.pushButton_5.setGeometry(QtCore.QRect(698, 0, 41, 31))
        font = QtGui.QFont()
        ...
        self.frame_4.setGeometry(QtCore.QRect(9, 350, 221, 251))
        # параметры текста для поля статуса
        ...
        self.pushButton_6.setGeometry(QtCore.QRect(10, 100, 50, 50))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/smile4.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_6.setIcon(icon)
        self.pushButton_6.setIconSize(QtCore.QSize(32, 32))
        self.pushButton_6.setObjectName("pushButton_6")
        self.pushButton_8 = QtWidgets.QPushButton(self.frame_4)
        self.pushButton_8.setGeometry(QtCore.QRect(60, 100, 50, 50))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("icons/smile5.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_8.setIcon(icon1)
        self.pushButton_8.setIconSize(QtCore.QSize(32, 32))
        self.pushButton_8.setObjectName("pushButton_8")
        self.pushButton_9 = QtWidgets.QPushButton(self.frame_4)
        self.pushButton_9.setGeometry(QtCore.QRect(10, 150, 50, 50))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("icons/smile6.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_10.setGeometry(QtCore.QRect(10, 50, 50, 50))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("icons/smile1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_11.setGeometry(QtCore.QRect(60, 50, 50, 50))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("icons/smile2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_12.setGeometry(QtCore.QRect(110, 50, 50, 50))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("icons/smile3.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_13.setGeometry(QtCore.QRect(160, 150, 50, 50))
        ...
        self.pushButton_14.setGeometry(QtCore.QRect(60, 150, 50, 50))
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("icons/smile10.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_15.setGeometry(QtCore.QRect(60, 200, 50, 50))
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("icons/smile11.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_16.setGeometry(QtCore.QRect(110, 100, 50, 50))
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("icons/smile9.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_17.setGeometry(QtCore.QRect(110, 150, 50, 50))
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("icons/smile8.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_18.setGeometry(QtCore.QRect(110, 200, 50, 50))
        ...
        self.pushButton_21.setGeometry(QtCore.QRect(160, 100, 50, 50))
        ...
        self.pushButton_22.setGeometry(QtCore.QRect(10, 200, 50, 50))
        ...
        self.pushButton_24.setGeometry(QtCore.QRect(160, 50, 50, 50))
        ...
        self.pushButton_25.setGeometry(QtCore.QRect(160, 200, 50, 50))
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("icons/smile16.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_7.setGeometry(QtCore.QRect(238, 560, 170, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        ...
        # кнопка "Регистрация"
        self.pushButton_30 = QtWidgets.QPushButton(self.frame)  # кнопка "Регистрация"
        self.pushButton_30.setGeometry(QtCore.QRect(238, 510, 170, 40))  # 290, 400, 170, 40
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_32.setGeometry(QtCore.QRect(418, 510, 170, 40))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        ...
        #self.pushButton_34.setGeometry(QtCore.QRect(470, 560, 170, 40))
        #font = QtGui.QFont()
        #font.setPointSize(11)
        #font.setBold(True)
        #font.setWeight(75)
        ...
        self.listWidget.setGeometry(QtCore.QRect(9, 38, 760, 304))  # --
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_30.setText(_translate("MainWindow", "Регистрация"))
        self.pushButton_32.setText(_translate("MainWindow", "Опции"))
        #self.pushButton_34.setText(_translate("MainWindow", "Выйти из чата"))
