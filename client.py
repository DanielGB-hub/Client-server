...
class Client(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.status = self.connect_to_server
        ...
        #self.ui.pushButton_30.clicked.connect(self.)  # кнопка "Регистрация"
        #self.ui.pushButton_32.clicked.connect(self.)  # кнопка "Опции"
        #self.ui.pushButton_34.clicked.connect(self.disconnect)
        #self.btn_hide(self.ui.pushButton_2, True)
        ...
        self.ui.pushButton_25.clicked.connect(lambda: self.smile_send('16'))
    ...
    def connect_to_server(self):
        ...
        if self.nick != None and self.password != None:
            try:
                ...
                self.btn_locker(self.ui.pushButton_30, True)
                # скрываем кнопки
                #self.btn_hide(self.ui.pushButton_2, True)
